...
The only package you need for the components to work is <code>@principium/theme</code>. This package not only provides the **tailwindcss plugin** that creates the styles for the components, but also the classes for the components themselves.
</div>
