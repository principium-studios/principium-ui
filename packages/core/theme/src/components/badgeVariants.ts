...
const badgeVariants = tv({
  slots: {
    ...
    badge: "flex z-10 flex-wrap absolute box-border rounded-full whitespace-nowrap justify-center origin-center items-center text-inherit select-none font-regular scale-100 opacity-100 subpixel-antialiased data-[invisible=true]:scale-0 data-[invisible=true]:opacity-0",
  },
  variants: {
    variant: {
      solid: {},
