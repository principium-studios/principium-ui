...
import {
  ...
  type PrimitiveProps,
  Ripple,
} from "@principium/utils/components";
import { cn } from "@principium/utils";
import { useRipple } from "@principium/utils/hooks";
...
const Button = ({
  ...
  VariantProps<typeof buttonVariants> & { ripple?: boolean }) => {
  ...
  return (
    ...
    >
      {children}
      {ripple && <Ripple ripples={ripples} removeRipple={removeRipple} />}
    </Primitive.button>
  );
};
